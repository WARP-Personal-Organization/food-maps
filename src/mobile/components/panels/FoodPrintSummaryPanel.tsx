...
// import FoodPrintTabs from "./TabPanel";
  ...
  return (
    ...
    >
      ...
      <div className="rounded-t-lg bg-white w-full p-6 pt-4 gap-4 z-10 relative -mt-[10%] flex flex-col">
        {/* Added flex flex-col here to manage internal layout, removed flex-1 and overflow */}
        {/* Label - FOODPRINT */}
        ...
        {/* Title */}
        <h1 className="px-0 text-3xl font-bold text-gray-900 mb-5 leading-tight">
          {" "}
          {/* Adjusted padding for consistency */}
        ...
        {/* food print tabs */}
        {/* <FoodPrintTabs photos={[]} menuItems={[]} reviewItems={"taste soo good love it"} /> */}
        ...
        <div className="sticky bottom-0 px-0 pb-6 bg-gradient-to-t from-white via-white to-transparent">
          {" "}
          {/* Adjusted padding for consistency and added pb-6 */}
          <div className="grid">
            <GetDirectionsButton
